...
import { TheLineChartComentsDataObject } from "../../../common/charts";
import { startOfWeek } from "date-fns/esm";

interface ProfileViewCommentsChartProps {
  data?: IntagramHistoricalType[];
}

export const ProfileViewCommentsChart: React.FC<ProfileViewCommentsChartProps> = ({
  data,
}) => {
    ...
    const mappedData = map(
      ...
      (
        ...
        return {
          ...
          comments: Number(e.AverageComments),
        };
      }
    );
  ...
  return (
    <>
      ...
      <div style={{ margin: "0 0 0 -30px", height: 245 }}>
        <TheLineChart data={dataState} dataKey="comments" />
      </div>
    </>
  );
};
