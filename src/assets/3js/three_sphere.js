...
function init()
{
 ...
 var materialGreen = new THREE.MeshBasicMaterial({transparent: false,  color: 0xffaeae,  opacity: 0.4,  side: THREE.DoubleSide});
 ...
 for (var p = 0; p < pitchSegments; p++) {
   ...
   for (var e = 0; e < elevationSegments; e++) {
     ...
     particle.userData = {dests: [dest,particle.position], speed: new THREE.Vector3() };
   }
 }
